<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/department/index.html";i:1521707192;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
            ...
            <tr>
                ...
                <td>
                    <div class="layui-table-cell laytable-cell-1-10">
                        ...
                        <a class="layui-btn layui-btn-danger layui-btn-mini" onclick="deleteFuc(this,<?php echo $v->id; ?>)" data-url='<?php echo url("Department/delete"); ?>'>删除</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
        ...
        layui.use('layer', function(){
            var layer = layui.layer;
             ...
             layer.open({
                 ...
                 type: 2,
                 area: ['500px', '300px'],
                 content: ['<?php echo url("Department/add"); ?>', 'no'],
                 end: function () {
                     location.reload();
                 }
            });
