<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/product_order/order.html";i:1522835365;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
    ...
    <div class="info">
        <table id="demo" class="layui-table" lay-data="{height:730, url:'<?php echo $url; ?>', page:true, id:'test'}" lay-filter="test">
            ...
            <tr>
                ...
                <th lay-data="{field:'product_name', width:268}">商品名</th>
                <th lay-data="{field:'total_jifen', width:100}">支付积分</th>
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layui.use('layer', function(){
                    ...
                    layer.open({
                        ...
                        type: 2,
                        area: ['800px', '800px'],
                        content: ['/index.php/admin/product_order/details?id='+id, 'no'],
                        end: function () {
                            location.reload();
                        }
                    });
                ...
                layer.confirm('确定此订单驳回吗？不可更改！', function(index){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo url("ProductOrder/order_del"); ?>',
                        dataType: 'json',
                        data: {id: id,status:5},
