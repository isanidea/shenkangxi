<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/role/index.html";i:1522311625;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
    ...
    <table class="layui-table">
        ...
        <?php foreach($list as $v): ?>
            <tr>
                ...
                <td>
                    <input type="text" value="<?php echo $v->sort; ?>" style="width: 60px;" onblur="saveSingleVal(this,<?php echo $v->id; ?>)" data-url='<?php echo url("Role/saveSort"); ?>'>
                </td>
                <td>
                    <div class="layui-table-cell laytable-cell-1-10">
                        ...
                        <a class="layui-btn layui-btn-danger layui-btn-mini" onclick="deleteFuc(this,<?php echo $v->id; ?>)" data-url='<?php echo url("Role/delete"); ?>'>删除</a>
                    </div>
                </td>
            </tr>
        <?php endforeach; ?>
        ...
        layui.use('layer', function(){
            var layer = layui.layer;
             ...
             layer.open({
                 ...
                 type: 2,
                 area: ['500px', '300px'],
                 content: ['<?php echo url("Role/add"); ?>', 'no'],
                 end: function () {
                     location.reload();
                 }
            });
