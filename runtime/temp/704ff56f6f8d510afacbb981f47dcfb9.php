<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:90:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/order/order_list.html";i:1522939433;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/public/base.html";i:1522831855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
    ...
    <ul>
        ...
        <li>
            <p>商品：<u><?php echo $d['pname']; ?></u>
                ...
                <?php elseif($d['status'] == 20): ?><span style="color:#8209FF;">已发货</span>
                <?php endif; ?></p>
            <p>价格:<?php echo $d['total_price']; ?>元</p>
            <p>购买时间：<?php echo date("Y-m-d H:m:s",$d['buy_time']); ?></p>
            <?php if($d['status']==6): ?>
            <a href='<?php echo url("Order/proof",array("id"=>$d['id'])); ?>'>上传凭证</a>
            <?php endif; ?>
        </li>
