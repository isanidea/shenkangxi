<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/order/product_order.html";i:1522833924;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/public/base.html";i:1522831855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="jsxx">
    ...
    <dl>
        ...
        <dd class="jsxx_tp">
            ...
            <span>积分：<?php echo $data['sales_jifen']; ?></span>
        </dd>
        <form id="orderForm" method="post" action='<?php echo url("Order/product_pay"); ?>'>
            <dd><a href="#">买家留言<input placeholder="填写卖家需求" type="text" id="remark" name="remark"/></a></dd>
            
            <dd class="dd_2"><i>总计：&nbsp;<?php echo $data['buy_num']*$data['sales_jifen']; ?> 积分</i></dd>
            
            <input type="hidden" id="pay_type" name="pay_type" value="1"/>
            <input type="hidden" id="address_id" name="address_id" value=""/>
            <input type="hidden" id="goods_id" name="product_id" value="<?php echo $data['id']; ?>"/>
            <input type="hidden" id="buy_sum" name="buy_sum" value="<?php echo $data['buy_num']; ?>"/>
            <input type="hidden" id="sales_jifen" name="sales_price" value="<?php echo $data['sales_jifen']; ?>"/>
            <input type="hidden" id="total_jifen" name="total_jifen"value="<?php echo $data['buy_num']*$data['sales_jifen']; ?>">
        </form>
        <a href='javascript:;' onclick="submitPay()">确认支付</a>
    </dl>
</div>
