<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:84:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/goods/edit.html";i:1522562876;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
...
<div style="width: 800px; padding-top: 30px;">
    <form method="post"  class="layui-form" action='<?php echo url("goods/edit"); ?>' enctype="multipart/form-data">
        <input type="hidden" name="id" value="<?php echo !empty($Arr['id'])?$Arr['id'] : 0; ?>">
        <div class="layui-form-item">
            <label class="layui-form-label">商品名</label>
            <div class="layui-input-inline">
                <input type="text" name="goods_name" lay-verify="required" autocomplete="off" class="layui-input" value="<?php echo !empty($Arr['goods_name'])?$Arr['goods_name'] : ''; ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">成本价</label>
            <div class="layui-input-inline">
                <input type="text" name="cost_price" lay-verify="number" autocomplete="off" class="layui-input" value="<?php echo !empty($Arr['cost_price'])?$Arr['cost_price'] : ''; ?>">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">出售价</label>
            <div class="layui-input-inline">
                <input type="text" name="sales_price"  lay-verify="number" autocomplete="off" class="layui-input" value="<?php echo !empty($Arr['sales_price'])?$Arr['sales_price'] : ''; ?>">
            </div>
        </div>
        <div class="layui-form-item">
...
//        });
    ...
    layui.use('upload', function(){
        ...
        var uploadInst = upload.render({
            elem: '#test1' //绑定元素
            ,url: '<?php echo url("goods/up_image"); ?>' //上传接口
            ,done: function(res){
                if(res.code == 0){
                    var da = res.msg;
