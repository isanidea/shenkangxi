<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:91:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/goods_order/order.html";i:1522944164;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
        ...
        <form class="layui-form" action="" method="get">
            ...
            <div class="layui-form-item" style="clear: none;float: left">
                ...
                <div class="layui-input-inline">
                    <input type="text" name="order_no"  lay-verify="sort" autocomplete="off" class="layui-input" value="<?php echo !empty($Arr['order_no'])?$Arr['order_no'] : ''; ?>">
                </div>
            </div>
            <div class="layui-form-item" style="clear: none;float: left">
    ...
    <div class="info">
        <table id="demo" class="layui-table" lay-data="{height:730, url:'<?php echo $url; ?>', page:true, id:'test'}" lay-filter="test">
            ...
            <tr>
                ...
                <th lay-data="{field:'order_no', width:180}">订单编号</th>
                <th lay-data="{field:'uid', width:100}">购买人ID</th>
                <th lay-data="{field:'goods_name', width:150}">商品名</th>
                <th lay-data="{field:'total_price', width:100}">支付金额</th>
                <th lay-data="{field:'buy_num', width:50}">数量</th>
            ...
            if(layEvent === 'detail'){ //查看
                ...
                layui.use('layer', function(){
                    ...
                    layer.open({
                        ...
                        type: 2,
                        area: ['800px', '800px'],
                        content: ['/index.php/admin/goods_order/details?id='+id, 'no'],
                        end: function () {
                            location.reload();
                        }
                    });
                ...
                layer.confirm('确定此订单驳回吗？不可更改！', function(index){
                    ...
                    $.ajax({
                        type: 'POST',
                        url: '<?php echo url("GoodsOrder/order_del"); ?>',
                        dataType: 'json',
                        data: {id: id,status:5},
