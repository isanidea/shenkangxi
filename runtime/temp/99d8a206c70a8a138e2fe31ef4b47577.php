<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/brokerage/index.html";i:1522674864;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
    ...
    <tr>
        ...
        <td>
            <div class="layui-table-cell laytable-cell-1-10">
                <a class="layui-btn layui-btn-mini" href='<?php echo url("Brokerage/edit",array("id"=>$v["id"])); ?>'  lay-event="edit">编辑</a>
            </div>
        </td>
    </tr>
    <?php endforeach; ?>
