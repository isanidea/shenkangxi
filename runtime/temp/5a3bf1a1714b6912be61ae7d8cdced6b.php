<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:95:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/package_order/details.html";i:1522932912;s:90:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/layerbase.html";i:1522469719;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="details">
    ...
    <li>
        <span>商品图片：</span>
        <a target="_blank" href='<?php echo url("Package/add",array("id"=>$Arr["pid"])); ?>'>
            <img src="<?php echo $Arr['pimg']; ?>">
        </a>
        <div style="clear: both"></div>
    </li>
    <li>
        <span>商品名：</span>
        <p><?php echo $Arr['pname']; ?></p>
        <div style="clear: both"></div>
    </li>

    <li>
        <span>商品价格：</span>
        <p style="color: red"><?php echo $Arr['sales_price']; ?>（元）</p>
        <div style="clear: both"></div>
    </li>
    <li>
        <span>购买数量：</span>
