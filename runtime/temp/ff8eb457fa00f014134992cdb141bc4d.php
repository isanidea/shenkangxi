<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:96:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/order/goods_order_list.html";i:1522944814;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/public/base.html";i:1522831855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="record">
    ...
    <ul>
        ...
        <li>
            <p>商品：<u><?php echo $d['goods_name']; ?></u>
                <?php if($d['status']==5): ?><span style="color:#FFBF05;">驳回</span>
                <?php elseif($d['status'] == 6): ?><span style="color:#FF1400;">待支付</span>
                <?php elseif($d['status'] == 10): ?><span style="color:#FF1400;">待审核</span>
                <?php elseif($d['status'] == 20): ?><span style="color:#FF1400;">已完成</span>
                <?php endif; ?></p>
             <p>数量：<?php echo $d['buy_num']; ?></p>
            <p>金额:<?php echo $d['total_price']; ?></p>
            <p>购买时间:<?php echo date("Y-m-d H:m:s",$d['add_time']); ?></p>
            <?php if($d['status']==6): ?>
            <a href='<?php echo url("Order/goods_proof",array("id"=>$d['id'])); ?>'>上传凭证</a>
            <?php endif; ?>
        </li>
