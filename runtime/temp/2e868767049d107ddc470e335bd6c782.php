<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:87:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/product/index.html";i:1522480177;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/base.html";i:1522395744;}*/ ?>
<!DOCTYPE html>
...
<a class="layui-btn layui-btn-normal" href='<?php echo url("product/add"); ?>' >添加商品</a>
...
<table class="layui-table">
    ...
    <tr>
        ...
        <td><?php echo $v->cost_jifen; ?></td>
        <td><?php echo $v->sales_jifen; ?></td>
        <td>
        ...
        <td>
            <div class="layui-table-cell laytable-cell-1-10">
                <a  class="layui-btn layui-btn-mini" href='<?php echo url("Product/add",array("id"=>$v["id"])); ?>' lay-event="edit">编辑</a>
                <?php if($v['status'] == 5): ?>
                <a onclick="saveStatusVal(this,'<?php echo $v->id; ?>',10)" data-url='<?php echo url("Product/saveStatus"); ?>' class="layui-btn layui-btn-normal layui-btn-mini" lay-event="edit">上线</>
                <?php elseif($v['status'] == 10): ?>
                <a onclick="saveStatusVal(this,'<?php echo $v->id; ?>',5)" data-url='<?php echo url("Product/saveStatus"); ?>' class="layui-btn layui-btn-normal layui-btn-mini" lay-event="edit">下线</a>
                <?php endif; ?>
                <a class="layui-btn layui-btn-danger layui-btn-mini" onclick="deleteFuc(this,'<?php echo $v->id; ?>')" data-url='<?php echo url("product/delete"); ?>'>删除</a>
            </div>
        </td>
    </tr>
    <?php endforeach; ?>
