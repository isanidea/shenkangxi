<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:89:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/package/details.html";i:1522928094;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/public/base.html";i:1522831855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="xxy_content">
    ...
    <span>价格：￥<?php echo $data['sales_price']; ?></span>
    <dl>
        <dd>销量：50件</dd>
        <dd>运费：（包邮）</dd>
...
<div class="zf">
    <div class="zf_z">
        ...
        <form id="orderForm" action='<?php echo url("Order/order"); ?>' method="post">
            <div class="slgm">
                <span>购买数量</span>
