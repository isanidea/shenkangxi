<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:93:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/goods_order/details.html";i:1522944292;s:90:"/Applications/MxSrvs/www/shenkangxi/public/../application/admin/view/public/layerbase.html";i:1522469719;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="details">
    ...
    <li>
        <span>商品名：</span>
        <p><?php echo $Arr['goods_name']; ?></p>
        <div style="clear: both"></div>
    </li>

    <li>
        <span>商品价格：</span>
        <p style="color: red"><?php echo $Arr['goods_price']; ?>（积分）</p>
        <div style="clear: both"></div>
    </li>
    <li>
        <span>购买数量：</span>
