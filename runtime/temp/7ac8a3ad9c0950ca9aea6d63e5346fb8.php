<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/goods/index.html";i:1522831909;s:85:"/Applications/MxSrvs/www/shenkangxi/public/../application/index/view/public/base.html";i:1522831855;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="container">
    ...
    <div class="content">
        ...
        <dl>
            ...
            <dd><a href="<?php echo url('goods/details',array('id'=>$v['id'])); ?>">
                <i><img src="<?php echo $v['img']; ?>"/></i>
                <h6><?php echo $v['goods_name']; ?></h6>
                <span>价格:&nbsp;<?php echo $v['sales_price']; ?></span>
            </a></dd>
