<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:86:"/Applications/MxSrvs/www/shenkangxi/public/../application/common/view/public/error.tpl";i:1522221107;}*/ ?>
<!doctype html>
<html>
<head>
    ...
    <style type="text/css">
    	*{
		...
		.error_cont{
			...
			background:url(__ADMIN__/images/warning.gif) 32px 32px no-repeat;
			line-height:1.8;
		}
		.error_return{
			padding:10px 0 0 0;
		...
		.btn {
			color: #333;
			background:#e6e6e6 url(__ADMIN__/images/image/btn.png);
